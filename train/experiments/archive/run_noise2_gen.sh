#!/bin/bash
# 단일오선 비중 상향(60%) + 복잡도 완화(short-note-bias 낮춤) + 대보표(40%) 총 5000장 생성.
# 노이즈 자체는 여기서 굽지 않음 -- dataset.py가 학습 시 --noise_level 2로 즉석 적용.
set -e
cd /workspace/round3train

OUT_DATA=/workspace/round3train/Round_noise2
