"""신규 추가 뉴에이지 6곡(newage21~26, 2026-08-04 촬영)의 4마디 트리밍 GT를
exactpicture_test_full/에 추가. _add_new_validation_gt.py와 동일 로직.
"""
import json
import sys
...
NEW_SONGS = ['newage21', 'newage22', 'newage23', 'newage24', 'newage25', 'newage26']
