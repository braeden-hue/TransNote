...
|---|---|---|---|---|
| 모델 크기 | 184.6MB | 300.2MB | **119.7MB**(FP32 대비 -60%, PyTorch보다도 35% 작음) | 150.3MB(FP32 대비 50%) |
| 추론 레이턴시(평균) | **3.2초** | 10.6초 | **8.0초**(FP32 대비 -25%) | 측정 불가(런타임 실패) |
...
디코더+일괄캐시는 위 두 수정을 반영한 dynamic-range로 export한다
